...
## [0.1.3](https://github.com/francisdb/jojodiff-rs/compare/v0.1.2...v0.1.3) - 2026-06-22

### Other

- *(deps)* bump actions/checkout from 6 to 7 ([#8](https://github.com/francisdb/jojodiff-rs/pull/8))
- *(deps)* bump actions/checkout from 5 to 6 ([#7](https://github.com/francisdb/jojodiff-rs/pull/7))
- remove cache
- remove cache
